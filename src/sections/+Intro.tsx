...
export function Intro() {
  return (
    <Root>
      ...
      <P>
        I'm a <G warm>Software Developer</G> in small team developing
        a website builder and CMS platform.
      </P>
      <P>
        I have a love for software engineering with <G cool>React</G> and
        <G cool> TypeScript</G>, and low-level application and game engine
        development with <G cool>C++20</G> and dable in <G cool>Web Assembly</G>.
      </P>
    </Root>
  );
}
